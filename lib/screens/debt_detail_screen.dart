...
class DebtDetailScreen extends ConsumerWidget {
                          ...
                          Row(
                            children: [
                              ...
                              PopupMenuButton<String>(
                                onSelected:
                                    (v) => _handleMenu(context, ref, v, debt),
                          ...
                          if (!debt.isActive) ...[
                            ...
                            Center(
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: DT.success.withValues(alpha: 0.18),
                                  borderRadius: BorderRadius.circular(8),
                                ),
                                child: Row(
                                  mainAxisSize: MainAxisSize.min,
                        ...
                        if (debt.isDebt) ...[
                          _StatRow(
                            cells: [
                              _StatCell(
                                'Total',
                                'RM${_fmt(debt.totalAmount)}',
                                accentColor,
                              ),
                              _StatCell(
                                'Paid',
                                'RM${_fmt(debt.totalPaid)}',
                                DT.success,
                              ),
                            ],
                          ),
                          ...
                          _StatRow(
                            cells: [
                              _StatCell(
                                'Remaining',
                                'RM${_fmt(debt.remainingBalance)}',
                                DT.warning,
                              ),
                              _StatCell(
                                'Monthly',
                                'RM${_fmt(debt.monthlyPayment)}',
                                DT.primary,
                              ),
                            ],
                          ),
                          ...
                          _StatRow(
                            cells: [
                              ...
                              _StatCell(
                                'Est. Payoff',
                                '${_month(debt.estimatedPayoffDate.month)} ${debt.estimatedPayoffDate.year}',
                                DT.catBills,
                              ),
                            ],
                          ),
    ...
    switch (action) {
      ...
      case 'complete':
        _dtDialog(
          ...
          body: 'This debt will be moved to the completed section.',
          confirmLabel: 'Complete',
          confirmColor: DT.success,
          onConfirm: () async {
      ...
      case 'delete':
        _dtDialog(
          ...
          body:
              'This will permanently delete "${debt.title}" and all payment history.',
          confirmLabel: 'Delete',
  ...
  void _confirmDeletePayment(
    ...
    _dtDialog(
      ...
      body:
          'Remove RM${payment.amount.toStringAsFixed(2)} payment from ${payment.paymentDate.day}/${payment.paymentDate.month}/${payment.paymentDate.year}?',
      confirmLabel: 'Delete',
      confirmColor: DT.danger,
      onConfirm: () async {
        final svc = ref.read(debtServiceProvider);
        await svc.deleteDebtPayment(
          debtId: debtId,
            ...
            builder:
                (ctx, setS) => Padding(
                  padding: EdgeInsets.fromLTRB(
                    ...
                    DS.xl,
                    DS.xl,
                    MediaQuery.of(ctx).viewInsets.bottom + DS.xl,
                  ),
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          try {
                            ...
                            if (debt.isDebt &&
                                debt.totalPaid + amount >= debt.totalAmount) {
                              await svc.markDebtComplete(debtId);
                            }
                            if (ctx.mounted) {
                            ...
                            if (ctx.mounted) {
                              showSnackBar(ctx, 'Failed: $e', isError: true);
                            }
                          }
                        },
                        child: Container(
                                ...
                                return GestureDetector(
                                  ...
                                  child: AnimatedContainer(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      borderRadius: BorderRadius.circular(10),
                                      border: Border.all(
                                        color: sel ? accentColor : DT.border,
                                      ),
                                    ),
                                    child: Row(
                                      mainAxisSize: MainAxisSize.min,
                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            if (creditor.isEmpty) {
                              showSnackBar(
                                ctx,
                                '${debt.isBill ? "Provider" : "Owed To"} is required',
                                isError: true,
                              );
                              return;
                            }
                            ...
                            final dueDay =
                                int.tryParse(dueDayCtrl.text.trim()) ?? 1;
