    ...
    return ListView(
      ...
      children: [
          ...
          children: [
            ...
            Expanded(
              child: _StatCard(
                ...
                iconColor: DT.danger,
                subtitle:
                    analytics.pendingExpenseAmount > 0
          ...
          children: [
            Expanded(
              child: _StatCard(
                ...
                iconBg:
                    analytics.netBalance >= 0 ? DT.successSoft : DT.dangerSoft,
        ...
        if (analytics.initialBalance != 0 ||
            analytics.outstandingLoans > 0) ...[
          const SizedBox(height: DS.sm),
          Row(
            children: [
              Expanded(
                child:
                    analytics.initialBalance != 0
                        ? _StatCard(
                          label: 'Starting Balance',
                          value:
                              'RM${analytics.initialBalance.toStringAsFixed(2)}',
                ...
                child:
                    analytics.outstandingLoans > 0
                        ? _StatCard(
                          label: 'Loans Out',
                          value:
                              'RM${analytics.outstandingLoans.toStringAsFixed(2)}',
                          icon: Icons.savings_outlined,
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    height: 40,
                    decoration: BoxDecoration(
                      color: medalColors[i].withValues(alpha: 0.12),
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text(
                                'RM${amount.toStringAsFixed(2)} (${(pct * 100).toStringAsFixed(1)}%)',
                                style: GoogleFonts.manrope(
                                  fontSize: 11,
                                  color: DT.textSecondary,
                                ),
  ...
  Widget build(BuildContext context) => Row(
    children: [
      Container(
        ...
        child: Icon(icon, size: 16, color: DT.primary),
      ),
      const SizedBox(width: 8),
      Text(
        title,
        ...
        if (subtitle != null) ...[
          ...
          Text(
            ...
            style: GoogleFonts.manrope(
              fontSize: 10,
              fontWeight: FontWeight.w700,
              color: subtitleColor ?? DT.textTertiary,
            ),
          ),
        ],
      ],
    ...
    child: Column(
      children: [
        ...
        if (amount != null) ...[
          ...
          Text(
            'RM${amount!.toStringAsFixed(2)}',
            style: GoogleFonts.manrope(fontSize: 10, color: DT.textTertiary),
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                child: Icon(Icons.speed, size: 16, color: color),
              ),
              const SizedBox(width: 8),
              Text(
                'Collection Rate',
          ...
          Row(
            ...
            children: [
              ...
              _labelValue(
                'Expected',
                'RM${analytics.expectedTotal.toStringAsFixed(2)}',
                DT.textSecondary,
              ),
            ],
          ),
        ...
        BarChartData(
            ...
            bottomTitles: AxisTitles(
              sideTitles: SideTitles(
                ...
                getTitlesWidget: (val, _) {
                  ...
                  final label =
                      parts.length > 1
                          ? months[(int.tryParse(parts[1]) ?? 1) - 1]
                          : '';
                  return Padding(
          ...
          gridData: FlGridData(
            ...
            getDrawingHorizontalLine:
                (_) => FlLine(color: DT.border, strokeWidth: 1),
          ),
...
class _CollVsExpChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final months =
        <String>{
            ...analytics.monthlyCollections.keys,
            ...analytics.monthlyExpenses.keys,
          }.toList()
          ..sort();
    final recent =
              ...
              BarChartData(
                ...
                barGroups: List.generate(recent.length, (i) {
                  ...
                  return BarChartGroupData(
                    ...
                    barRods: [
                      BarChartRodData(
                        toY: analytics.monthlyCollections[m] ?? 0,
                        color: DT.accent,
                        width: 10,
                        borderRadius: const BorderRadius.vertical(
                      ...
                      BarChartRodData(
                        toY: analytics.monthlyExpenses[m] ?? 0,
                        color: DT.danger,
                        width: 10,
                        borderRadius: const BorderRadius.vertical(
                          top: Radius.circular(4),
                  ...
                  (e) => Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 6),
                        _ProgressBar(
                          fraction: (maxVal > 0 ? e.value / maxVal : 0.0).clamp(
                            0.0,
                            1.0,
                          ),
                          color: barColor,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${e.requestedByName} · ${e.date.day} ${_months[e.date.month - 1]} ${e.date.year}',
                              style: GoogleFonts.manrope(
                                fontSize: 10,
                                color: DT.textSecondary,
                              ),
...
class _ActivityCard extends StatelessWidget {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _row(
            'Inactive Members',
            inactive < 0 ? '0' : inactive.toString(),
  ...
  Widget _row(String label, String value, IconData icon, Color color) => Row(
    children: [
      Container(
        padding: const EdgeInsets.all(7),
        decoration: BoxDecoration(
...
class _YearlySummaryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final years =
        <int>{
            ...analytics.yearlyCollections.keys,
            ...analytics.yearlyExpenses.keys,
          }.toList()
              ...
              return Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Text(
                        net >= 0
                            ...
                            : '-RM${net.abs().toStringAsFixed(2)}',
                        style: GoogleFonts.manrope(
                          fontSize: 14,
                          fontWeight: FontWeight.w800,
                          color: net >= 0 ? DT.success : DT.danger,
                        ),
                      ),
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: _yearStat('Collected', collected, DT.success),
                      ),
                      const SizedBox(width: DS.sm),
                      Expanded(
                        child: _yearStat('Expenses', expenses, DT.danger),
                      ),
                    ],
                  ),
                ],
  ...
  Widget _yearStat(String label, double amount, Color color) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Text(
        label,
    ...
    child: Column(
      children: [
        Container(
          ...
          child: Icon(icon, size: 32, color: DT.textSecondary),
        ),
        const SizedBox(height: DS.md),
        Text(
          message,
    ...
    child: Column(
      ...
      children: [
        Container(
          ...
          child: const Icon(Icons.error_outline, size: 36, color: DT.danger),
        ),
        const SizedBox(height: DS.md),
        Text(
