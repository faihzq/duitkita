...
import 'package:duitkita/features/profile/delete_account_sheet.dart';
...
class _ProfileScreenState extends ConsumerState<ProfileScreen> {
  ...
  Future<void> _pickImage(ImageSource source) async {
    ...
    try {
      ...
      final cropped = await ImageCropper().cropImage(
        ...
        uiSettings: [
          AndroidUiSettings(
            ...
            toolbarColor: const Color(0xFF0B1F3A),
            toolbarWidgetColor: Colors.white,
            activeControlsWidgetColor: DT.accent,
      ...
      final url = await ref
          ...
          .uploadProfileImage(userId: userId, file: File(cropped.path));
  ...
  void _showOnboarding() {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        ...
        builder:
            (_) => OnboardingScreen(onDone: () => Navigator.of(context).pop()),
      ),
    );
  }
  ...
  Future<void> _migrateEmail(String uid, String email) async {
    try {
      ...
      showSnackBar(context, 'Email added to profile');
    } catch (e) {
      if (!mounted) return;
      showSnackBar(context, 'Failed: $e', isError: true);
    }
                              ...
                              saving
                                  ...
                                  : () async {
                                    ...
                                    try {
                                      ...
                                      final wanted = normaliseUsername(
                                        usernameCtrl.text,
                                      );
                                      if (wanted.isNotEmpty &&
                                          wanted != profile.username) {
                                      ...
                                      // Carry the new handle through: copyWith
                                      // would otherwise keep the old one, and
                                      // toMap() writes username — reverting
                                      // the claim we just made and leaving the
                                      // profile disagreeing with the
                                      // reservation.
              ...
              (profile) => SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(DS.cardRadius),
                          border: Border.all(
                            color: DT.danger.withValues(alpha: 0.2),
                          ),
                        ),
                        child: Row(
                    ...
                    // ── Delete account ───────────────────────────────
                    // Google Play requires an in-app route to deletion for any
                    // app with accounts. Kept quiet next to Sign out so it is
                    // findable without being easy to hit by mistake.
                    const SizedBox(height: 10),
                    Center(
                      child: TextButton(
                        ...
                        child: Text(
                          ...
                          style: GoogleFonts.manrope(
                            ...
                            decorationColor: DT.textTertiary,
                          ),
                        ),
                      ),
                    ),
