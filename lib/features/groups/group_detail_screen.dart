...
class _GroupDetailScreenState extends ConsumerState<GroupDetailScreen> {
  ...
  int _monthDir =
      1; // +1 = moving forward, -1 = moving back (drives hero slide direction)
  ...
  Future<Map<String, _PayInfo>> _fetchPaymentStatus(
          ...
          (_) => _MonthPickerSheet(
            ...
            onPicked:
                (m, y) => setState(() {
                  ...
                  _monthDir =
                      (y * 12 + m) >= (_selectedYear * 12 + _selectedMonth)
                          ? 1
                          : -1;
                  _selectedMonth = m;
                  _selectedYear = y;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Monthly collection stops. Members can still add expenses and loans to track where the money goes. You can reopen it anytime from settings.',
                    style: GoogleFonts.manrope(
                      fontSize: 13,
  ...
  Widget build(BuildContext context) {
    ...
    return groupAsync.when(
      ...
      data: (group) {
        ...
        final allPayments =
            ref
                .watch(groupPaymentsStreamProvider(widget.groupId))
                .valueOrNull ??
            [];
                        ...
                        if (settled || goal > 0)
                          Padding(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color:
                                    settled ? DT.successSoft : DT.catGroupsSoft,
                                borderRadius: BorderRadius.circular(
                                  DS.cardRadius,
                                ),
                                border: Border.all(
                                  color: (settled ? DT.success : DT.catGroups)
                                ...
                                children: [
                                  Row(
                                    children: [
                                      Icon(
                                        ...
                                        size: 18,
                                        color:
                                            settled ? DT.success : DT.catGroups,
                                      ),
                                      ...
                                      if (!settled)
                                        Text(
                                          '${((totalCollected / goal) * 100).clamp(0, 100).toStringAsFixed(0)}%',
                                          style: GoogleFonts.manrope(
                                            fontSize: 13,
                                            fontWeight: FontWeight.w800,
                                            color: DT.catGroups,
                                  ...
                                  if (!settled) ...[
                                    ...
                                    ClipRRect(
                                      ...
                                      child: LinearProgressIndicator(
                                        value: (totalCollected / goal).clamp(
                                          0.0,
                                          1.0,
                                        ),
                                        minHeight: 7,
                                  ...
                                  if (settled)
                                    Padding(
                                      ...
                                      child: Text(
                                        'No monthly collection — expenses & loans still tracked.',
                                        style: GoogleFonts.manrope(
                                          fontSize: 11.5,
                                          color: DT.textSecondary,
                                        ),
                                  ...
                                  if (goalReached && !settled) ...[
                                    ...
                                    if (isAdmin)
                                      ...
                                      Text(
                                        '🎉 Goal reached! Waiting for an admin to settle.',
                                        style: GoogleFonts.manrope(
                                          fontSize: 12,
                            ...
                            children: [
                              ...
                              _MembersTab(
                                ...
                                onNavigate:
                                    (screen) => Navigator.of(
                                      context,
                                    ).push(AppTheme.slideRoute(screen)),
                              ),
                              // Activity tab
                              _ActivityTab(
                                groupId: widget.groupId,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 6),
                  Text(
                    'Reason for rejecting $memberName\'s payment:',
                    style: GoogleFonts.manrope(
                      fontSize: 13,
                      color: DT.textSecondary,
                      height: 1.4,
            ...
            child: Column(
              ...
              children: [
                ...
                _MoreTile(
                  ...
                  label: 'Members',
                  subtitle: 'Add, remove & manage roles',
                  onTap:
                      () => go(
                        sheetCtx,
                        ManageMembersScreen(
                ...
                _MoreTile(
                  ...
                  onTap:
                      () =>
                          go(sheetCtx, PaymentHistoryScreen(groupId: groupId)),
                ),
                _MoreTile(
                  icon: Icons.upload_outlined,
                  label: 'Bulk import',
                  subtitle: 'Import past payments',
                  onTap:
                      () => go(
                        sheetCtx,
                        BulkImportScreen(
                          ...
                          groupCreatedAt: group.createdAt as DateTime,
                        ),
                      ),
                ),
              ],
      ...
      children: [
                ...
                if (isAdmin)
                  Consumer(
                    builder: (context, ref, _) {
                      final count =
                          ref
                              .watch(pendingPaymentsStreamProvider(groupId))
                              .valueOrNull
                              ?.length ??
                          0;
                      return _QuickChip(
                        label: 'Review${count > 0 ? ' ($count)' : ''}',
                  ...
                  builder: (context, ref, _) {
                    final count =
                        isAdmin
                            ? (ref
                                    .watch(
                                      pendingFundLoansCountProvider(groupId),
                                    )
                                    .valueOrNull ??
                                0)
                            : 0;
                    return _QuickChip(
                      label: 'Loans${count > 0 ? ' ($count)' : ''}',
                      icon: Icons.savings_outlined,
                      onTap:
                          () => onNavigate(
                            FundLoansScreen(
        ...
        AnimatedSwitcher(
          ...
          transitionBuilder: (child, animation) {
            final isIncoming =
                child.key == ValueKey('$selectedMonth-$selectedYear');
...
class _ActivityTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final paymentsAsync = ref.watch(
      monthPaymentsStreamProvider((groupId: groupId, month: month, year: year)),
    );
          ...
          children: [
            ...
            if (isAdmin && pendingCount > 0)
              GestureDetector(
                onTap:
                    () => onNavigate(
                      ExpenseListScreen(groupId: groupId, groupName: groupName),
                    ),
                child: Container(
                  padding: const EdgeInsets.all(14),
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          '$pendingCount expense${pendingCount > 1 ? 's' : ''} pending review',
                          style: GoogleFonts.manrope(
                            fontSize: 13,
                            fontWeight: FontWeight.w700,
                            color: DT.warning,
    ...
    return Container(
      ...
      child: Column(
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      info.amount != null
                          ? 'RM${info.amount!.toStringAsFixed(2)}'
                          : 'RM${(group.monthlyAmount as double).toStringAsFixed(2)} due',
                      style: GoogleFonts.manrope(
                        fontSize: 11,
                        color: DT.textSecondary,
                      ),
          ...
          // Rejection reason
          if (status == 'rejected' &&
              info.payment?.rejectionReason?.isNotEmpty == true) ...[
            const SizedBox(height: 8),
            Container(
              width: double.infinity,
              ...
              child: Text(
                'Reason: ${info.payment!.rejectionReason}',
                style: GoogleFonts.manrope(fontSize: 11, color: DT.danger),
              ),
            ),
          ],
        ],
...
class _ActionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        color: primary ? DT.accent : DT.surface,
        borderRadius: BorderRadius.circular(16),
        ...
        children: [
          Container(
            ...
            child: Icon(
              icon,
              size: 17,
              color: primary ? Colors.white : (iconFg ?? DT.text),
            ),
          ),
          const SizedBox(height: 8),
          Text(
...
class _CollectionHero extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final double pct =
        members > 0 ? (paidCount / members).clamp(0.0, 1.0) : 0.0;
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                hasFund ? 'COLLECTED THIS MONTH' : 'TRIP FUND',
                style: GoogleFonts.manrope(
                  fontSize: 11,
                  fontWeight: FontWeight.w700,
                  color: white55,
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          '${_kMonths[selectedMonth - 1].substring(0, 3)} $selectedYear',
                          style: GoogleFonts.manrope(
                            fontSize: 12,
                            fontWeight: FontWeight.w700,
                            color: white,
                ...
                if (hasFund) ...[
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Text(
                        'of RM${(monthly * members).toStringAsFixed(0)}',
                        style: GoogleFonts.manrope(
                          fontSize: 14,
                          fontWeight: FontWeight.w600,
                          color: white70,
                  ...
                  const SizedBox(height: 10),
                  Text(
                    'No fixed amount — costs are split between $members members as they come up.',
                    style: GoogleFonts.manrope(
                      fontSize: 15,
                      fontWeight: FontWeight.w600,
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      _heroStat(
                        'PER MEMBER',
                        hasFund ? 'RM${perMember.toStringAsFixed(0)}' : '—',
  ...
  Widget _heroStat(String label, String value, CrossAxisAlignment align) =>
      Expanded(
        child: Column(
                  ...
                  child: Center(
                    child: Text(
                      ...
                      style: GoogleFonts.manrope(
                        fontSize: 13,
                        fontWeight: FontWeight.w700,
                        color: active ? DT.text : DT.textSecondary,
                      ),
                    ),
                  ),
                ),
        ...
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.manrope(
              fontSize: 10,
              fontWeight: FontWeight.w700,
              color: DT.text.withValues(alpha: 0.7),
              letterSpacing: 0.4,
            ),
          ),
        ],
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(999),
        border: Border.all(
          color: highlight ? DT.warning.withValues(alpha: 0.4) : DT.border,
        ),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.manrope(
              fontSize: 12,
              fontWeight: FontWeight.w600,
              color: highlight ? DT.warning : DT.text,
            ),
          ),
        ],
      ),
        ...
        child:
            photoUrl != null && photoUrl.isNotEmpty
                ? Image.network(
                  ...
                  fit: BoxFit.cover,
                  errorBuilder:
                      (_, __, ___) => _InitialsAvatar(initials: initials),
                )
