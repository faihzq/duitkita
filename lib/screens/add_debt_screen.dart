...
class _AddDebtScreenState extends ConsumerState<AddDebtScreen> {
  ...
  final _monthlyController =
      TextEditingController(); // debt monthly / bill amount (hero)
  ...
  TextEditingController get _heroController =>
      _isDebt ? _totalController : _monthlyController;
  ...
  double get _monthlyNum =>
      double.tryParse(_monthlyController.text.trim()) ?? 0;
  int get _payoffMonths =>
      _isDebt && _totalNum > 0 && _monthlyNum > 0
          ? (_totalNum / _monthlyNum).ceil()
          : 0;
          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  DT.primary,
                  _isDebt ? const Color(0xFF1A2E50) : const Color(0xFF2A1F0A),
                ],
              ),
            ),
            child: SafeArea(
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                _isDebt
                                    ? 'Track a loan you’re paying down'
                                    : 'Track a recurring monthly bill',
                                style: GoogleFonts.manrope(
                                  fontSize: 12,
                      ...
                      child: Row(
                        children: [
                          _TypeTab(
                            ...
                            selected: _isDebt,
                            onTap: () => _switchType('debt'),
                          ),
                          _TypeTab(
                            label: 'Bill',
                            icon: Icons.receipt_long_outlined,
                            selected: !_isDebt,
                            onTap: () => _switchType('bill'),
                          ),
                        ],
                      ),
                    ),
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      _isDebt ? 'TOTAL AMOUNT' : 'MONTHLY AMOUNT',
                      style: GoogleFonts.manrope(
                        fontSize: 11,
                ...
                children: [
                  FloatingField(
                    ...
                    hint:
                        _isDebt
                            ? 'e.g. Car loan, PTPTN'
                            : 'e.g. Unifi fibre, Netflix',
                    capitalization: TextCapitalization.words,
                  ),
                  FloatingField(
                    controller: _creditorController,
                    label: _isDebt ? 'Lender' : 'Biller',
                    icon: Icons.account_balance_outlined,
                    hint: _isDebt ? 'Who you owe' : 'Company you pay',
                    capitalization: TextCapitalization.words,
                  ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Icon(
                                    cat.icon,
                                    size: 18,
                                    color: sel ? _accent : DT.textSecondary,
                                  ),
                                  const SizedBox(height: 6),
                                  Text(
                                    cat.label,
                  ...
                  if (_isDebt)
                    FloatingField(
                      ...
                      hint: 'How much you repay each month',
                      prefixText: 'RM ',
                      keyboardType: const TextInputType.numberWithOptions(
                        decimal: true,
                      ),
                        ...
                        _kDueDays.map((day) {
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: sel ? DT.text : DT.surface,
                                borderRadius: BorderRadius.circular(10),
                                border: Border.all(
                                  color: sel ? DT.text : DT.border,
                                ),
                              ),
                              child: Text(
                                '$day${day == 1 ? 'st' : 'th'}',
                                style: GoogleFonts.manrope(
                                  fontSize: 13,
                                  fontWeight: FontWeight.w700,
                                  color: sel ? Colors.white : DT.text,
                                ),
                              ),
                            ),
                          );
                  ...
                  if (_isDebt && _payoffMonths > 0) ...[
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: DT.catDebts.withValues(alpha: 0.10),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  '$_payoffMonths payment${_payoffMonths == 1 ? '' : 's'} of RM ${_monthlyNum.toStringAsFixed(0)}',
                                  style: GoogleFonts.manrope(
                                    fontSize: 11.5,
                                    fontWeight: FontWeight.w500,
                                    color: DT.textSecondary,
            ...
            child: AnimatedContainer(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    _heroNum > 0
                        ? 'RM ${_heroNum.toStringAsFixed(2)}${_isDebt ? '' : '/mo'}'
                        : 'Enter amount',
                    style: GoogleFonts.manrope(
                      fontSize: 13,
                      fontWeight: FontWeight.w600,
                      color: _canSubmit ? Colors.white70 : DT.textTertiary,
                    ),
                  ),
                  _isLoading
                      ? const SizedBox(
                        ...
                        children: [
                          Text(
                            ...
                            style: GoogleFonts.manrope(
                              ...
                              fontWeight: FontWeight.w800,
                              color:
                                  _canSubmit ? Colors.white : DT.textTertiary,
                              letterSpacing: -0.2,
                            ),
                          ),
                          const SizedBox(width: 8),
          ...
          children: [
            ...
            Text(
              ...
              style: GoogleFonts.manrope(
                fontSize: 13.5,
                fontWeight: FontWeight.w700,
                color: selected ? DT.text : Colors.white70,
              ),
            ),
          ],
        ),
